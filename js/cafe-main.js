...
const boardData = {
  1: {
    id: 1,
    category: "notice",
    title: "[공지] 202호 누전 수리 완료 및 공실 임시 대여 안내",
    writer: "오재현(관리)",
    date: "2020.09.01",
    viewCount: 24,
    content: `주민 및 본가/가지 식구 여러분 안녕하십니까. 온누리부동산 오재현입니다.

지난달 202호 내부 배선 문제로 발생했던 누전 수리 및 도배 작업이 모두 마무리되었습니다. 
그동안 인천 현장 지원이나 대기 목적으로 202호를 임시 이용하시던 본가/가지 식구분들께서는 당분간 다른 거처를 이용해 주시기 바랍니다.

202호는 정식 입주 수속 및 정리가 끝나는 대로 신규 입주민이 들어올 예정입니다. 
건물 내 보안 및 사생활 보호 수칙은 이전과 동일하게 유지되니 협조 부탁드립니다.`,
    comments: [
      { writer: "김서현", date: "09.01 10:15", text: "재현 삼촌 고생 많으셨어요! 수리 및 정산 비용은 원(元) 쪽 경비 계좌로 처리해 두었습니다." },
      { writer: "윤도현", date: "09.01 11:02", text: "아 202호 누워서 폰 보기 딱 좋았는데 아쉽네 ㅋㅋㅋ" },
      { writer: "박상철", date: "09.01 11:20", text: "@윤도현 너는 본가 방 두고 왜 남의 빌라 빈방에 와서 자꾸 자빠져 자냐?" }
    ]
  },
  2: {
    id: 2,
...
원서 번역본이라 가볍게 읽기 좋습니다. 데이터 분석이나 리그 흐름 파악에 관심 있으신 분은 201호로 올라오시거나 연락 주십시오. 일정 기간 대여 가능합니다.`,
    comments: [
      { writer: "박상철", date: "09.04 09:05", text: "태규 형님 그거 읽으면 이번 주 승무패 맞출 수 있습니까? ㅋㅋㅋ" },
      { writer: "이태규", date: "09.04 09:30", text: "@박상철 그럴 리가 있겠습니까." }
    ]
  },
  3: {
    id: 3,
