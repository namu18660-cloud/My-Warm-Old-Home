...
const sidebarInfoData = {
  "101호": {
    title: "⭐ 101호 | 정지아·박상철",
    content: "한빛빌라 공동명의자 부부 정지아, 박상철이 거주하는 공간입니다.\n<공간구조>\n![101호구조](https://github.com/user-attachments/assets/37552053-7739-403f-bd00-d6c55bb3ac04)"
  },
   "202호": {
    title: "★ 202호 | (입주예정)",
    content: "말도안되게 싼 월세! 지금 당장 입주하세요!\n시작설정'애착손님'\n![202호입주](https://github.com/user-attachments/assets/04241c86-1a06-4d51-9675-620919c8bfdf)"
  },
  "정지아": {
    title: "🧊 정지아 (정나)",
  ...
  "박상철": {
    title: "🐕 박상철 (퍼스트)",
    content: "소속: 퍼스트 흥신소\n35/ 男/ ENTJ/ 8w7 \n 체격: 188cm/ 골격이 크고 단단함\n색: 가을웜톤/ 난갈색 머리/ 황갈색 눈\n얼굴: 쌍꺼풀/ 처진 눈매/ 진한 눈썹/ 턱선이 선명함/쾌남 인상/ 집중할때 안경 씀\n귀를 살짝 덮는 중단발/ 대충 넘긴 자연곱슬/ 이마 드러냄\n한빛빌라 및 주안4동의 마당발. 흥신소의 운영 및 탐문담당.\n물건을 대충 두고, 잘 잃어버린다더라."
  },
  "윤서우": {
    title: "🦉 윤서우 (정가)",
    content: "소속: 정보부 가\n 24/ 女/ INTJ / 5w6\n157cm/ 탈색금발/ 홍안\n데이터·온라인 조사 실무자. 어린나이에 능력을 인정받은 유망주.\n최근 관심사는 생활력 갈고닦기라더라."
  },
  "이태규": {
    title: "🐈‍⬛ 이태규 (퍼스트)",
    content: "소속: 퍼스트 흥신소\n35/ 男/ INTP/ 5w4\n179cm/ 흑발/ 흑안\n흥신소 조사·자료분석 담당 직원. 상철과는 고교동찰.\n귀찮음과 흥미로움이 늘 충돌한다더라."
  },
   "윤도현": {
    title: "🔥 윤도현 (실가)",
    content: "소속: 실행부 가\n28/ 男/ ESTP/ 7w8/\n193cm/ 흑발/ 적안\n낮에는 기술직, 밤에는...?\n상철과는 친한 형동생사이.\n 방문시 늘 선물을 들고온다던가."
